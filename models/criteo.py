...
from datasets.criteo.criteo_data import *


class CriteoModel(splitNN.splitNN):
    def __init__(self, cfg):
        super(CriteoModel, self).__init__(
        ...
        train_set = Criteo(guest_cols, host_cols, istrain=True)
        test_set = Criteo(guest_cols, host_cols, istrain=False)
        ...
        self.guest_top_model = wide_deep.GuestTopModel(fc_dims=[activation_dim] + top_fc)
